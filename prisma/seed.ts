...
const img = (seed: string, _n?: number) => `/products/${SEED_ART[seed] ?? "generic"}.svg`;
  ...
  const products = [
    {
      ...
      price: 1899,
      compareAtPrice: 2299,
      images: [img("vx-dot", 1), img("vx-dot", 2), img("vx-dot", 3)],
    ...
    },
    {
      ...
      price: 1599,
      compareAtPrice: null,
      images: [img("element-section", 1), img("element-section", 2)],
    ...
    },
    {
      ...
      price: 1749,
      compareAtPrice: null,
      images: [img("indys-stage11", 1), img("indys-stage11", 2)],
    ...
    },
    {
      ...
      price: 999,
      compareAtPrice: null,
      images: [img("spitfire-f4", 1), img("spitfire-f4", 2)],
    ...
    },
    {
      ...
      price: 1799,
      compareAtPrice: 2099,
      images: [img("vans-oldskool", 1), img("vans-oldskool", 2), img("vans-oldskool", 3)],
    ...
    },
    {
      ...
      price: 1649,
      compareAtPrice: null,
      images: [img("sb-force58", 1), img("sb-force58", 2)],
    ...
    },
    {
      ...
      price: 1299,
      compareAtPrice: 1499,
      images: [img("thrasher-hoodie", 1), img("thrasher-hoodie", 2)],
