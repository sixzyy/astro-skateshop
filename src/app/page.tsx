    ...
    <>
      ...
      <section className="reveal-section mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            { icon: Truck, title: "Envio gratis", text: "En compras desde $999 COP" },
            ...
            <div
              key={f.title}
              className="flex items-start gap-4 rounded-lg border border-border bg-background-secondary/50 p-6 transition-all duration-300 hover:border-border-active hover:shadow-[0_4px_20px_rgba(84,216,255,0.04)]"
            >
            ...
            {categories.map((cat) => {
              ...
              return (
                <Link
                  ...
                  className="reveal-section group flex flex-col items-center gap-3 rounded-lg border border-border bg-background-secondary/30 p-6 text-center transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-border-active hover:-translate-y-1 hover:shadow-[0_4px_20px_rgba(84,216,255,0.04)]"
                >
                  <span className="inline-flex h-11 w-11 items-center justify-center rounded-lg border border-border text-foreground-secondary transition-colors duration-300 group-hover:border-accent/40 group-hover:text-accent">
